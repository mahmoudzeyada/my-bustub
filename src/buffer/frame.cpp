...
namespace bustub {
	...
	bool Frame::IsPinned() {
		return ref == PIN_VALUE;
	}
	bool Frame::IsUnpinned() {
		return !IsPinned();
	}
	void Frame::Remove() {
	...
	bool Frame::IsRemoved() {
		return removable == REMOVED_VALUE;
	}
	bool Frame::CanBeRemoved() {
		return !IsRemoved() && IsPinned();
	}
